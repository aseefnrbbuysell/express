...
<!-- Mirrored from pages.revox.io/dashboard/latest/html/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Jan 2017 04:45:30 GMT -->
<head>
    ...
    <link href="{{ asset('plugins/bootstrap-notify/css/bootstrap-notify.css') }}" rel="stylesheet" type="text/css"/>
...
<body class="fixed-header dashboard" ng-app="myApp">
...
<nav class="page-sidebar" data-pages="sidebar">
    ...
    <div class="sidebar-header">
        <img src="{{ asset('img/logo.png') }}" alt="logo" class="brand" data-src="{{ asset('img/logo.png') }}" data-src-retina="img/logo.png') }}" width="78" height="22">
    ...
    <div class="sidebar-menu">
        ...
        <ul class="menu-items">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li class="">
                        <a href="{{ url('dashboard/clients/list') }}">Clients</a>
                        <span class="icon-thumbnail">C</span>
                    </li>
                    <li class="">
                        <a href="{{ url('dashboard/employees/list') }}">Employees</a>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li class="">
                        <a href="{{ url('dashboard/orders/all') }}">View All</a>
                        <span class="icon-thumbnail">C</span>
                    </li>
                </ul>
            </li>
            <li>
                <a href="javascript:;"><span class="title">Couriers</span>
                    <span class=" arrow"></span></a>
                <span class="icon-thumbnail"><i class="pg-calender"></i></span>
                <ul class="sub-menu">
                    <li class="">
                        <a href="{{ url('dashboard/couriers/all') }}">View All</a>
                        <span class="icon-thumbnail">C</span>
                    </li>
                </ul>
            </li>
                                        ...
                                        <div class="notification-item unread clearfix">
                                            <div class="heading">
                                                <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                                                    <img width="30" height="30" data-src-retina="img/profiles/1x.jpg') }}" data-src="{{ asset('img/profiles/1.jpg') }}" alt="" src="{{ asset('img/profiles/1.jpg') }}">
                                                </div>
                                                <a href="#" class="text-complete pull-left">
...
<img src="{{ asset('img/profiles/avatar.jpg') }}" alt="" data-src="{{ asset('img/profiles/avatar.jpg') }}" data-src-retina="img/profiles/avatar_small2x.jpg') }}" width="32" height="32">
</span>
                    </button>
...
<img width="34" height="34" alt="" data-src-retina="img/profiles/1x.jpg') }}" data-src="{{ asset('img/profiles/1.jpg') }}" src="{{ asset('img/profiles/1x.jpg') }}" class="col-top">
</span>
</span>
...
<span class="col-xs-height col-middle">
<span class="thumbnail-wrapper d32 circular bg-success">
<img width="34" height="34" alt="" data-src-retina="img/profiles/2x.jpg') }}" data-src="{{ asset('img/profiles/2.jpg') }}" src="{{ asset('img/profiles/2x.jpg') }}" class="col-top">
</span>
</span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
...
<span class="col-xs-height col-middle">
<span class="thumbnail-wrapper d32 circular bg-success">
<img width="34" height="34" alt="" data-src-retina="img/profiles/3x.jpg') }}" data-src="{{ asset('img/profiles/3.jpg') }}" src="{{ asset('img/profiles/3x.jpg') }}" class="col-top">
</span>
</span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
...
<span class="col-xs-height col-middle">
<span class="thumbnail-wrapper d32 circular bg-success">
<img width="34" height="34" alt="" data-src-retina="img/profiles/4x.jpg') }}" data-src="{{ asset('img/profiles/4.jpg') }}" src="{{ asset('img/profiles/4x.jpg') }}" class="col-top">
</span>
</span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
...
<span class="col-xs-height col-middle">
<span class="thumbnail-wrapper d32 circular bg-success">
<img width="34" height="34" alt="" data-src-retina="img/profiles/5x.jpg') }}" data-src="{{ asset('img/profiles/5.jpg') }}" src="{{ asset('img/profiles/5x.jpg') }}" class="col-top">
</span>
</span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
...
<span class="col-xs-height col-middle">
<span class="thumbnail-wrapper d32 circular bg-success">
<img width="34" height="34" alt="" data-src-retina="img/profiles/6x.jpg') }}" data-src="{{ asset('img/profiles/6.jpg') }}" src="{{ asset('img/profiles/6x.jpg') }}" class="col-top">
</span>
</span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
...
<span class="col-xs-height col-middle">
<span class="thumbnail-wrapper d32 circular bg-success">
<img width="34" height="34" alt="" data-src-retina="img/profiles/7x.jpg') }}" data-src="{{ asset('img/profiles/7.jpg') }}" src="{{ asset('img/profiles/7x.jpg') }}" class="col-top">
</span>
</span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
...
<span class="col-xs-height col-middle">
<span class="thumbnail-wrapper d32 circular bg-success">
<img width="34" height="34" alt="" data-src-retina="img/profiles/8x.jpg') }}" data-src="{{ asset('img/profiles/8.jpg') }}" src="{{ asset('img/profiles/8x.jpg') }}" class="col-top">
</span>
</span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
...
<span class="col-xs-height col-middle">
<span class="thumbnail-wrapper d32 circular bg-success">
<img width="34" height="34" alt="" data-src-retina="img/profiles/9x.jpg') }}" data-src="{{ asset('img/profiles/9.jpg') }}" src="{{ asset('img/profiles/9x.jpg') }}" class="col-top">
</span>
</span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                    ...
                    <div class="chat-inner" id="my-conversation">
                        ...
                        <div class="message clearfix">
                            <div class="profile-img-wrapper m-t-5 inline">
                                <img class="col-top" width="30" height="30" src="{{ asset('img/profiles/avatar_small.jpg') }}" alt="" data-src="{{ asset('img/profiles/avatar_small.jpg') }}" data-src-retina="img/profiles/avatar_small2x.jpg') }}">
                            </div>
                ...
                <div class="scrollable">
                    <div class="p-l-10 p-r-50">
                        ...
                        <div class="row p-b-35">
                            <div class="col-xs-6 ">
                                <a class="btn-toggle-layout fs-12 active " data-action="menuDefault" href="#"><img alt="Menu divided icon" class="m-b-15" src="{{ asset('img/demo/menu_divided_con.png') }}" data-src="{{ asset('img/demo/menu_divided_con.png') }}" data-src-retina="img/demo/menu_divided_con_2x.png') }}" width="126" height="95">
                                    <span class="text-dark m-t-5">Divided Header & Condensed / Quick
Menu</span></a>
                            </div>
                            <div class="col-xs-6">
                                <a class="btn-toggle-layout fs-12" data-action="menuBelow" href="#">
                                    <img alt="Full header icon" class="m-b-15 " src="{{ asset('img/demo/full_header_con.png') }}" data-src-retina="img/demo/full_header_con_2x.png') }}" width="126" height="95"> <span class="text-dark m-t-5">Full Width Header & Condensed/ Quick
Menu</span></a>
                            </div>
                        </div>
                        <div class="row p-b-10 ">
                            <div class="col-xs-6">
                                <a class="btn-toggle-layout fs-12" data-action="menuPinned" href="#">
                                    <img alt="Menu divided" class="m-b-15" src="{{ asset('img/demo/menu_divided.png') }}" data-src="{{ asset('img/demo/menu_divided.png') }}" data-src-retina="img/demo/menu_divided_2x.png') }}" width="126" height="95"> <span class="text-dark m-t-5">Divided Header & Fixed/Pinned Menu</span></a>
                            </div>
                            <div class="col-xs-6">
                                <a class="btn-toggle-layout fs-12" data-action="menuPinnedBelow" href="#"><img alt="Full header" class="m-b-15" src="{{ asset('img/demo/full_header.png') }}" data-src="{{ asset('img/demo/full_header.png') }}" data-src-retina="img/demo/full_header_2x.png') }}" width="126" height="95">
                ...
                <div class="scrollable">
                    <div class="p-l-10 p-r-50">
                        ...
                        <a href="#" class="btn-toggle-theme b-a b-grey active theme-selector m-b-30" data-action="default">
                            <img alt="Theme default" src="{{ asset('img/demo/theme_default.png') }}" class="image-responsive-height">
                        ...
                        <a href="#" class="btn-toggle-theme b-a b-grey theme-selector m-b-30" data-action="corporate">
                            <img alt="Theme corporate" src="{{ asset('img/demo/theme_corporate.png') }}" class="image-responsive-height">
                            <div class="p-l-15 p-r-20 p-b-10 p-t-10">
                                <p class="no-margin">
                        ...
                        <a href="#" class="btn-toggle-theme b-a b-grey theme-selector m-b-30" data-action="retro">
                            <img alt="Theme retro" src="{{ asset('img/demo/theme_retro.png') }}" class="image-responsive-height">
                            <div class="p-l-15 p-r-20 p-b-10 p-t-10">
                                <p class="no-margin">
                        ...
                        <a href="#" class="btn-toggle-theme b-a b-grey theme-selector m-b-30" data-action="unlax">
                            <img alt="Theme unlax" src="{{ asset('img/demo/theme_unlax.png') }}" class="image-responsive-height">
                            <div class="p-l-15 p-r-20 p-b-10 p-t-10">
                                <p class="no-margin">
                        ...
                        <a href="#" class="btn-toggle-theme b-a b-grey theme-selector m-b-30" data-action="vibes">
                            <img alt="Thmeme vibes" src="{{ asset('img/demo/theme_vibes.png') }}" class="image-responsive-height">
                            <div class="p-l-15 p-r-20 p-b-10 p-t-10">
                                <p class="no-margin">
                        ...
                        <a href="#" class="btn-toggle-theme b-a b-grey theme-selector m-b-30" data-action="abstract">
                            <img alt="Theme abstract" src="{{ asset('img/demo/theme_abstract.png') }}" class="image-responsive-height">
                            <div class="p-l-15 p-r-20 p-b-10 p-t-10">
                                <p class="no-margin">
...
<div class="overlay hide" data-pages="search">
    ...
    <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
            ...
            <img class="overlay-brand" src="{{ asset('img/logo.png') }}" alt="logo" data-src="{{ asset('img/logo.png') }}" data-src-retina="img/logo_2x.png') }}" width="78" height="22">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            ...
                            <div class="thumbnail-wrapper d48 circular bg-success text-white inline m-t-10">
                                <div>
                                    <img width="50" height="50" src="{{ asset('img/profiles/avatar.jpg') }}" data-src="{{ asset('img/profiles/avatar.jpg') }}" data-src-retina="img/profiles/avatar2x.jpg') }}" alt="">
                                </div>
                            </div>
...
<script src="{{ asset('plugins/mapplic/js/hammer.js') }}"></script>
...
<script src="{{ asset('plugins/bootstrap-notify/js/bootstrap-notify.js') }}" type="text/javascript"></script>
...
$(document).ready(function(){
    ...
    $('#default_datetimepicker').change(function(){
        date = new Date($('#default_datetimepicker').val());
        day = date.getDate();
        ...
        $('#default_datetimepicker').val(year + "-" + month + "-" + day);
    });
